...
image: /images/projects/tw-covid-bot.png
links:
  [
...
- Volunteered to organize developers to set up a server and built a bot using web crawling, image generation, and data analysis
- Automatically graphed daily COVID-19 cases from 200 countries to track the spread
